let colors=[
   ...
   //  {name:'rebeccapurple', color:'#663399',}, 
    'rebeccapurple',
   //   {name:'slatebluepurple', color:'#6A5ACD',},
    'slatebluepurple',
   //   {name:'mediumpurple', color:'#9370DB;',},
    'mediumpurple',
   //   {name:'carbonred', color:'#A70D2A;',},
    'carbonred',
   // {name:'red', color:'#FF0000',},
   'red',
   //   {name:'pastelred', color:'#F67280',},
    'pastelred',
   ...
   // {name:'yellow', color:'#FFFF00',},
    'yellow',
   //   {name:'pastelyellow', color:'',},
    'pastelyellow',
   //   {name:'boldyellow', color:'#F9DB24',},
   'boldyellow', 
   //   {name:'lightyellow', color:'#FAF884',},
    'lightyellow',
   ]
     ...
     textColor.innerHTML = document.getElementById(id).value;
      ...
      function filterArray(colour){
         ...
         const cont=document.getElementById('container')
          const newColor= colors.filter((color,index)=>color.includes(colour));
         ...
         //  const myDiv = document.createElement('div');
           for(i=0;i<newColor.length;i++){
            ...
            myDiv.style.backgroundColor =  `.${newColor[i]}`;
            let myTextNode=document.createTextNode(newColor[i])
