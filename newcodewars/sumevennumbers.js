...
function lastEventNums(arr,num){
  //filter even numbers
  //slice arr from the end
  return arr.filter(n => n % 2 === 0).slice(-num)

}

console.log(lastEventNums([1, 2, 3, 4, 5, 6, 7, 8, 9], 3),[4, 6, 8])
console.log(lastEventNums([-22, 5, 3, 11, 26, -6, -7, -8, -9, -8, 26], 2),[-8, 26])
