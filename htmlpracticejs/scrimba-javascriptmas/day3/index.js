...
const colours=document.querySelector('.colors');
const body = document.body;
const container = document.getElementById("container")
const btn = document.getElementById("btn")
const text = document.getElementById("text")
const radioBtns=document.querySelector('.radio-buttons')
const ele = document.getElementsByName('theme');
...
function fix() {
  ...
  const newyear=(day===31 && month===12)?true:false
  console.log(newyear)
  if(newyear){
      newyearTheme();
    }
...
function snowTheme(){
    // snowBtn.classList.ass
    console.log("in")
    wrapper.style.display="block";
    colours.style.background="#ffd200";
    wrapper.style.width="1000px"
    greeting.innerHTML = 'Warm Greetings<br>🥶 🌁 🌬️🔥 🎿 🧣 ❄️ ☃️ ❄ 🌨 🏔️ 🧤 🏂';
     body.style.background="#ffd200";
    body.style.backgroundImage="url('aesthetic3.jpg')"
    body.style.backgroundSize="cover"
    body.style.backgroundRepeat="no-repeat"
    body.style.backgroundPosition="center"
    greeting.style.color="#9c5708";
    wrapper.style.background="#42687C";
    wrapper.style.marginLeft="400px";
    greeting.style.fontSize="30px";
    greeting.style.fontFamily = "Dancing Script , Roboto";
...
function christmasTheme(){
  console.log("christmasim")
  colours.style.background="#00B32C";
  wrapper.style.display="block";
  wrapper.style.margin="auto";
  body.style.background="#00B32C";
  body.style.backgroundImage="url('redchristmas.jpg')"
    body.style.backgroundSize="cover"
    body.style.backgroundRepeat="no-repeat"
    body.style.backgroundPosition="center"
  greeting.innerHTML = " Merry Christmas!!! <br>🎄🎅🍪🦌🔔 🎁🎉🤶🛷 ☃️";
  greeting.style.color="#344D2F";
  wrapper.style.background="#D03D33";
  greeting.style.fontSize="30px";
  greeting.style.fontFamily = "Dancing Script , Roboto";
  btn.style.visibility="hidden";
  container.style.visibility="visible";
...
function treeTheme(){
    ...
    wrapper.style.display="block";
    wrapper.style.margin="auto";
    colours.style.background="#84A5B8";
    body.style.background="#84A5B8";
    body.style.backgroundImage="url('tree1.jpg')"
    body.style.backgroundSize="cover"
    body.style.backgroundRepeat="no-repeat"
    body.style.backgroundPosition="center"
    greeting.innerHTML = " Season's Greetings!!! <br>🎄🎁 🕯️🍪🧦🔔 🥛 🎶";
    greeting.style.color="#B3DAF1";
    wrapper.style.background="#4F7942";
    greeting.style.fontSize="30px";
    greeting.style.fontFamily = "Dancing Script , Roboto";
    btn.style.visibility="hidden";
    container.style.visibility="visible";
...
function newyearTheme(){
    ...
    colours.style.background="#84A5B8";
    body.style.background="#84A5B8";
    greeting.innerHTML = " Happy New Year!!! <br> 🎄🎅🍪🦌🔔🎁🎉🤶🛷 ☃️";
    greeting.style.color="#B3DAF1";
    wrapper.style.background="#42687C";
    greeting.style.fontSize="30px";
    greeting.style.fontFamily = "Dancing Script , Roboto";
