...
function clearField() {
  document.querySelector("input").value = ""
    ...
    // document.querySelector('#meal-type').selectedindex=null;
      document.querySelector('#meal-type').value='select';
}
...
const createIngredients = (meal) => {
  console.log(meal)
    ...
    totalNutrient = meal.recipe.totalDaily
   ...
   <div class="card-container">
     <div class="card-wrapper">
      <div class="card-details">
        ...
        <a href="edmamnutriVal.html" id="modal-btn" class="button btn btn-primary getNutrition"> Nutrition Labels</button>
