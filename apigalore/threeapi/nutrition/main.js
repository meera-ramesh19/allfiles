   ...
   <div class="card-container">
     <div class="card-wrapper">
      <div class="card-details">
        ...
        <div class="recipe-card__nav">
          <a href="#" class="btn btn-primary" id="${meals.recipe}">Nutrition Info</a>
    ...
    ` )
        ...
        async function nutritionalLabels(label) {
          ...
          app_ids='3fbb56a0'
          app_keys=`7c1f1da42c85743aabd55887e22ca4aa`
          document.querySelector('#showNutrition').innerHTML='';
         try{
                 const url2=`https://api.edamam.com/api/nutrition-details/?app_id=${app_ids}&app_key=${app_keys}&nutrtion-type=${nutri_type}
                 &ingr=${inger}`
