...
async function getPhotos(start,end) {
 ...
 try {
  ...
  function createColumnCards(dataInfo,i){
    ...
    let videoUrl = parseVideo(urls)
     console.log(videoUrl,urls)
       ...
       <div class="displayContainer">
        <div class="mediaContainer">
            <div class="media">
             <div class="image">
               ${ mediaType==="image"
                 ? `<img src=${hdImage} style="width:550px; height:200px;" alt="Nasa Image of the Day"/>`
                 :""}
              </div>
              <div class="video">
                   ${ videoUrl==="youtube" ? `<iframe  src=${dataInfo.url}  frameborder="0" width=200 height=200 ></iframe>`
                   : videoUrl==="vimeo" ?`<iframe src=${dataInfo.url} frameborder="0"width=200 height=200> </iframe> >` :""
